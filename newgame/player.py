...
class Player(pygame.sprite.Sprite, ):
    ...
    def check_contact(self):
        ...
        right_rect = pygame.Rect(self.hitbox_rect.topright + vt(0, self.hitbox_rect.height / 4),
                                 (2, self.hitbox_rect.height / 2))
        left_rect = pygame.Rect(self.hitbox_rect.topleft + vt(-2, self.hitbox_rect.height / 4),
                                (2, self.hitbox_rect.height / 2))
