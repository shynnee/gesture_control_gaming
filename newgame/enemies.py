...
class Tooth(pygame.sprite.Sprite):
    ...
    def update(self,dt):
        ...
        wall_rect = pygame.Rect(self.rect.topleft + vt(-1,0),(self.rect.width +2, 1))
...
class Shell(pygame.sprite.Sprite):
    ...
    def state_management(self):
        player_pos, shell_pos = vt(self.player.hitbox_rect.center),vt(self.rect.center)
    ...
    def update(self, dt):
        ...
        if self.frame_index < len(self.frames[self.state]):
            ...
            if self.state == 'fire' and int(self.frame_index) == 3 and not self.has_fire:
...
class Pearl(pygame.sprite.Sprite):
    def __init__(self, pos, groups, surf, direction, speed):
        ...
        super().__init__(groups)
        self.image = surf
        self.rect = self.image.get_rect(center = pos + vt(50 * direction,0))
